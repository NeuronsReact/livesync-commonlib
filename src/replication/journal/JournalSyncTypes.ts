...
export const CURSOR_REPORT_ADVANCE_THRESHOLD = 3; // 3 for testing, 32 for production
export const CURSOR_REPORT_MIN_INTERVAL_MS = 60_000;
export const COMPACT_TRIGGER_MIN_RAW_JOURNALS = 6; // 6 for testing, 64 for production
